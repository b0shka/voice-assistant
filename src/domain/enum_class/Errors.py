...
class Errors(Enum):
	...
	MONITORING_NEW_TELEGRAM_MESSAGES = 'Ошибка при мониторинге новых сообщений в Телеграм'
	PROCESSING_NEW_TELEGRAM_MESSAGES = 'Ошибка при обработке нового сообщения в Телеграм'
	...
	MONITORING_NEW_VK_MESSAGES = 'Ошибка при мониторинге новых сообщений в ВКонтакте'
	PROCESSING_NEW_VK_MESSAGES = 'Ошибка при обработке нового сообщения в ВКонтакте'
